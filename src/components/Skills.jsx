            ...
            >
              ...
              <ul className="space-y-5 relative z-10">
                {[
                  ...
                  <li key={i} className="flex items-center gap-4 text-on-surface-variant/80 font-medium text-sm sm:text-base group/item">
                    <span className="material-symbols-outlined text-blue-500/60 text-xl group-hover/item:text-blue-400 transition-colors">
                      check_circle
                    </span>
                    <span className="group-hover/item:text-on-background transition-colors">{skill}</span>
                  </li>
                ))}
              </ul>
            </motion.div>
