...
Readers can browse curated collections, pay delivery fees via Stripe, and track their orders in real time.Librarians manage their inventory and delivery pipeline.Admins oversee the entire ecosystem with analytics and moderation tools.`,
  ...
  return (
    <section
      ref={sectionRef}
      className="max-w-360 mx-auto px-4 sm:px-8 md:px-12 py-12 md:py-16 relative overflow-hidden"
      id="projects"
    >
            ...
            {Array.from({ length: totalPages }, (_, index) => {
              ...
              return (
                <button
                  ...
                  className={`w-8 h-8 flex items-center justify-center rounded-lg font-bold text-xs transition-all duration-300 border ${currentPage === pageNumber
